...
st.markdown("<h1 style='text-align: center; color: red;'>Bird Species Classification</h1>", unsafe_allow_html=True)
...
def loading_model():
    model_path = ('models/TchMach_model.h5')
